...
class _BloodRegisterScreenState extends State<BookBloodScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DonatebloodCubit, DonatebloodState>(
      listener: (context, state) {
        if (state is DonatebloodLoading) {
          isLoading = true;
        } else if (state is DonatebloodSuccesse) {
          isLoading = false;
          context.pushNamed(Routes.myNavigationBar);
        } else if (state is DonatebloodFailure) {
                                ...
                                : AppTextButton(
                                    ...
                                    onPressed: () async {
                                      if (formKey.currentState!.validate()) {
                                        ...
                                        BlocProvider.of<DonatebloodCubit>(
                                                context)
                                            .register(
                                                id: id!,
                                                hospitalCenter:
