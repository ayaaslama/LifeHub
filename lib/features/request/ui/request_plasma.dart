...
class _BloodRegisterScreenState extends State<SearchPlasmaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<RequestplasmaCubit, RequestplasmaState>(
        listener: (context, state) {
          if (state is RequestplasmaLoading) {
            isLoading = true;
          } else if (state is RequestplasmaSuccesse) {
            isLoading = false;
            context.pushNamed(Routes.myNavigationBar);
          } else if (state is RequestplasmaFailure) {
                                ...
                                : AppTextButton(
                                    ...
                                    onPressed: () async {
                                      if (formKey.currentState!.validate()) {
                                        ...
                                        BlocProvider.of<RequestplasmaCubit>(
                                                context)
                                            .booked(
                                                id: id!,
                                                hospitalCenter:
