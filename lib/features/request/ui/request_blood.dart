...
class _BloodRegisterScreenState extends State<SearchBloodScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<RequestbloodCubit, RequestbloodState>(
        listener: (context, state) {
          if (state is RequestbloodLoading) {
            isLoading = true;
          } else if (state is RequestbloodSuccesse) {
            isLoading = false;
            context.pushNamed(Routes.myNavigationBar);
          } else if (state is RequestbloodFailure) {
                                ...
                                : AppTextButton(
                                    ...
                                    onPressed: () async {
                                      if (formKey.currentState!.validate()) {
                                        ...
                                        BlocProvider.of<RequestbloodCubit>(
                                                context)
                                            .booked(
                                                id: id!,
                                                hospitalCenter:
